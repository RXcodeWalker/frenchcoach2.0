  ...
  return (
    <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-800/60 border border-slate-700/60">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs font-bold text-slate-300">Offline analysis — limited feedback</p>
      ...
      <button
        ...
        className="flex-shrink-0 p-1 rounded-lg hover:bg-white/5 text-slate-600 hover:text-slate-400 transition-colors"
      >
        <X size={12} />
      </button>
    </div>
