...
const initialProfile: UserProfile = {
  ...
  sessions_count: 47,
  total_words_spoken: 8921,
};

const mockSessions: Session[] = [
  { id: '1', mode: 'practice', topicKey: 'school', questionText: "Parle-moi de ton ecole.", wordCount: 87, score: 7.8, xpEarned: 25, durationSec: 145, createdAt: new Date(Date.now() - 1000 * 60 * 30).toISOString() },
  ...
  { id: '5', mode: 'practice', topicKey: 'environment', questionText: "Parle des problemes environnementaux.", wordCount: 103, score: 8.9, xpEarned: 35, durationSec: 187, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 72).toISOString() },
];
...
function reducer(state: AppState, action: Action): AppState {
  switch (action.type) {
    ...
    case 'ADD_SESSION': {
      ...
      return { ...state, profile: newProfile, recentSessions: [action.session, ...state.recentSessions].slice(0, 20) };
    }
