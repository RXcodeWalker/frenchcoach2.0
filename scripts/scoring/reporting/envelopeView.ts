...
import type { EvidenceSpan, SpeakingTranscript, TopicConversation } from '../../../src/domain/igcse/judgement/types';
import type { TeacherMark, TeacherMarkSet } from '../../../src/domain/igcse/comparison/teacherMark';
