...
- **Conversation interaction signals:** number of times the examiner had to repeat a question, number of times an alternative question was triggered (these map directly to Cambridge's band-language: "frequently requires use of the alternative question(s) provided" is the 7–9 band marker).
